...
<c:set var="tituloDaPagina" value="LISTA DE FORNECEDORES" scope="request" />
		...
		<c:forEach var="fornecedor" items="${fornecedores}" varStatus="id">
			<tr id="fornecedor_${fornecedor.id}">
				...
				<td><a href="#editModal" class="edit"
					...
					href="#deleteModal" onclick="atualizarId(${fornecedor.id})"
...
<div id="deleteModal" class="modal">
    ...
    <div class="modal-footer">
      <a href="#!" onclick="excluirFornecedor()" class="modal-close waves-effect waves-green btn-flat">SIM</a>
