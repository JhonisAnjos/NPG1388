...
<c:set var="tituloDaPagina" value="LISTA DE TRANSPORTADORAS" scope="request" />
		...
		<c:forEach var="transportadora" items="${transportadoras}" varStatus="id">
			<tr id="transportadora_${transportadora.id}">
				...
				<td><a href="#editModal" class="edit"
					...
					href="#deleteModal" onclick="atualizarId(${transportadora.id})"
...
<div id="deleteModal" class="modal">
    ...
    <div class="modal-footer">
      <a href="#!" onclick="excluirTransportadora()" class="modal-close waves-effect waves-green btn-flat">SIM</a>
